...
export const CARDS_DATA: RecipeCardData[] = [
  {
    title: "Ineffable",
  ...
  },
  {
    ...
    items: [
      ...
      "How you turn a 'nothing' Tuesday into a state of {Eudaimonia}—just flourishing"
    ],
    definitions: {
      "Incandescent": "Emitting light as a result of being passionate.",
      "Ethereal": "Extremely delicate and light; heavenly.",
      "Iridescent": "Luminous colors that change when seen from different angles.",
      "Luminescence": "A soft, glowing light produced from within.",
      "Halcyon": "A period of time that is idyllically happy and peaceful.",
      "Eudaimonia": "The highest human good; flourishing and contentment."
    }
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      "Prioritize the {Aurora}—the dawn of new ideas and 'do-overs' every single day",
      "Protect the {Incandescent} spark that happens when we’re just being us"
    ],
    definitions: {
      "Redamancy": "The act of loving the one who loves you; love returned in full.",
      "Felicity": "Intense happiness.",
      "Aurora": "The dawn; a new beginning.",
      "Incandescent": "Brilliant; full of light and heat."
    }
  },
  {
    title: "The Shift",
  ...
  },
  {
    ...
    definitions: {
      "Incandescent": "Passionate and brilliant.",
      "Iridescent": "Ever-changing and luminous."
    }
  }
];
